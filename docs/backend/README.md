...
> สถานะ: แบบร่างระหว่างออกแบบโครงสร้างเอกสาร
...
CI docs guard ยังไม่ได้สร้างในช่วงออกแบบนี้ ต้องสรุป checkpoint และข้อยกเว้นที่เหลือก่อนเพื่อไม่ให้เกิด false positive
...
กำลังสรุปลำดับความน่าเชื่อถือ วิธีบังคับตำแหน่งไฟล์ วิธีจัดการไฟล์ซ้ำ และ workflow การอัปเดตเอกสารเมื่อ backend contract เปลี่ยน
