...
> สถานะ: แผน migration ยืนยันแล้ว; legacy files ยังไม่ถูกย้ายหรือลบในงานออกแบบนี้
...
เริ่ม execution เป็นงานแยกโดยทำตามลำดับ batch ด้านล่างและ [file-by-file migration map](./documentation-migration-map.md) ห้ามรวมทุก capability เป็น change เดียว
...
- ทำ migration batch 1-4 ตาม [file-by-file migration map](./documentation-migration-map.md)
- implement guard ตาม [CI documentation guard specification](../guides/documentation/docs-guard-spec.md)
- บันทึก deployment cycle ที่เริ่มวาง pointer ก่อนลบ legacy pointer ใน change ถัดไป
