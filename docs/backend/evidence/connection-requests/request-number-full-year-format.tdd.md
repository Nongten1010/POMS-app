...
| GREEN | คำสั่ง RED เดิม | PASS: 2 suites, 38 tests | formatter คืน `CEMS-0001/2569` และ `WPMS-0003/2569`; Direct Connection query เฉพาะ sequence ของระบบและปีเดียวกัน |
...
| 5 | การเปลี่ยนนี้ไม่แก้ formatter หรือ sequence ของ `measurementPoints[].pointCode` | diff review + point-code contract แยก | Scope verification | PASS |
...
- RED checkpoint: `fbb536b test: require full-year request number format`
- GREEN checkpoint: `f18fa83 fix: use full-year request number format`
