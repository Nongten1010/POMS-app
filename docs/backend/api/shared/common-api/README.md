...
Swagger UI ครอบคลุม 114 canonical endpoints และแสดง 123 operations แยกเป็น 11 กลุ่มงาน การเปิดหน้าเอกสารไม่ได้ข้าม auth ของ endpoint ที่กดทดสอบ และ `Try it out` อาจเปลี่ยนข้อมูลใน environment ปัจจุบันจริง
