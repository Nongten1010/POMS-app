...
1. อ่านโรงงานจาก active `cems_wpms_connected_measurement_points` ที่ผูก active `eligible_factories`.
2. ใช้ `factories` เป็นข้อมูลเสริมและเป็น ownership gate สำหรับ `OWN_FACTORY` เท่านั้น.
...
| `data[].factoryName` | string | ชื่อโรงงานจาก factory master หรือโรงงานเข้าข่าย |
...
| Evidence | [Officer-connected dashboard TDD](../../../evidence/home/officer-direct-connected-dashboard.tdd.md) |
