...
| 4 | `valueRange.min` | ค่าต่ำสุดของช่วงข้อมูล |
| 5 | `valueRange.max` | ค่าสูงสุดของช่วงข้อมูล |
| 6 | `valueFormat` | รูปแบบค่า เช่น `MEASUREMENT_VALUE`, `CURRENT`, `VOLTAGE` |
| 7 | `offset` | Offset |
| 8 | `encoding` | Encoding สำหรับ Modbus |
| 9 | `standardCriteria` | ค่ามาตรฐานตามประกาศ อก. หรือ `null` |
| 10 | `eiaCriteria` | ค่ามาตรฐานตาม EIA หรือ `null` |
| 11 | `status` | สถานะพารามิเตอร์ เช่น `Normal`, `Calibration`, `Maintenance` |
