...
| 8 | `alertLow` | ค่า Alert(Low) ของ channel หรือ `null` |
| 9 | `alertHigh` | ค่า Alert(High) ของ channel หรือ `null` |
| 10 | `valueFormat` | รูปแบบค่า เช่น `MEASUREMENT_VALUE`, `CURRENT`, `VOLTAGE` |
| 11 | `offset` | Offset |
| 12 | `encoding` | Encoding สำหรับ Modbus |
| 13 | `standardCriteria` | ค่ามาตรฐานตามประกาศ อก. หรือ `null` |
| 14 | `eiaCriteria` | ค่ามาตรฐานตาม EIA หรือ `null` |
| 15 | `status` | สถานะพารามิเตอร์ เช่น `Normal`, `Calibration`, `Maintenance` |
