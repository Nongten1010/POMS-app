...
| `factorySubclass` | `sqlservice.diw.go.th` / `diw.dbo.FACCLASS.CLASS` join ด้วย `FID` | ใช้เลข 3 ตัวท้ายจาก `CLASS`, ตัดเลขที่ซ้ำกับประเภทหลัก, มากกว่า 1 ค่า join ด้วย comma |
