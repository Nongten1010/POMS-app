...
export const PERMISSIONS: Array<{ code: string; resource: string; action: string; description: string }> = [
  // dashboard
  { code: 'dashboard:view', resource: 'dashboard', action: 'view', description: 'ดู dashboard หน้าหลัก' },
  { code: 'dashboard.alerts:view', resource: 'dashboard.alerts', action: 'view', description: 'ดูการแจ้งเตือนติดดาว' },
  { code: 'dashboard.search:basic', resource: 'dashboard.search', action: 'basic', description: 'ค้นหาทั่วไป' },
  { code: 'dashboard.search:advanced', resource: 'dashboard.search', action: 'advanced', description: 'ค้นหาขั้นสูง' },
  { code: 'dashboard.stats:view', resource: 'dashboard.stats', action: 'view', description: 'ดูสถิติข้อมูล' },
  { code: 'dashboard.stats:export', resource: 'dashboard.stats', action: 'export', description: 'ส่งออกข้อมูล' },
  ...
  { code: 'factories:approve', resource: 'factories', action: 'approve', description: 'อนุมัติข้อมูลพื้นฐานโรงงาน' },

  // CEMS/WPMS connection requests
  { code: 'cems_wpms_requests:view', resource: 'cems_wpms_requests', action: 'view', description: 'ดูคำขอเชื่อมต่อ CEMS/WPMS' },
  { code: 'cems_wpms_requests:edit', resource: 'cems_wpms_requests', action: 'edit', description: 'แก้ไขคำขอเชื่อมต่อ CEMS/WPMS' },
  { code: 'cems_wpms_requests:approve', resource: 'cems_wpms_requests', action: 'approve', description: 'อนุมัติคำขอเชื่อมต่อ CEMS/WPMS' },
  ...
  // BOD/COD errors
  { code: 'bod_cod_errors:view', resource: 'bod_cod_errors', action: 'view', description: 'ดูรายงานค่าความคลาดเคลื่อน BOD/COD' },
  { code: 'bod_cod_errors:edit', resource: 'bod_cod_errors', action: 'edit', description: 'แก้ไขรายงานค่าความคลาดเคลื่อน BOD/COD' },
  { code: 'bod_cod_errors:approve', resource: 'bod_cod_errors', action: 'approve', description: 'อนุมัติรายงานค่าความคลาดเคลื่อน BOD/COD' },

  // Notifications
  { code: 'notifications:view', resource: 'notifications', action: 'view', description: 'ดูการแจ้งเตือน' },
  { code: 'notifications:view_status', resource: 'notifications', action: 'view_status', description: 'ดูสถานะการแจ้งเตือน' },
  { code: 'notifications:edit', resource: 'notifications', action: 'edit', description: 'แก้ไขการแจ้งเตือน' },
  { code: 'notifications:approve', resource: 'notifications', action: 'approve', description: 'อนุมัติการแจ้งเตือน' },
