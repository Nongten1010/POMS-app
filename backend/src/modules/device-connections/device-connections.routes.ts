...
deviceConnectionsRoutes.get('/', authorize('cems_wpms_requests:view'), deviceConnectionsController.list);
deviceConnectionsRoutes.get('/:id', authorize('cems_wpms_requests:view'), deviceConnectionsController.getById);
