...
export interface IdentityProvider {
  ...
  authenticateOperator(username: string, password: string): Promise<OperatorProfile | null>;
...
```
[Frontend] POST /api/v1/auth/login { userType, username, password, departmentID? }
   ↓
